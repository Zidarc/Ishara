...
# Cross-platform paths: raw video source and processed output directories
video_path = BASE_DIR.parent / "raw_videos" / "IMG_5081.MOV"
if not video_path.exists():
    video_path = BASE_DIR / "IMG_5081.MOV"

# Output dataset directories inside datasets/processed/
output_640 = BASE_DIR.parent / "processed" / "dataset_640x640"
output_1280 = BASE_DIR.parent / "processed" / "dataset_1280x1280"

# Create output folders inside the processed directory
