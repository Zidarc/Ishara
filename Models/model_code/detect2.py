...
input_video_path = "darkspot.MOV"
output_video_path = "output_processed_dark.mp4"

cap = cv2.VideoCapture(input_video_path)
fps = cap.get(cv2.CAP_PROP_FPS)

# Output resolution (Downscaling from 4K to 1080p width for side-by-side)
out_width = 1920
out_height = 540 # Side-by-side means each frame is 960x540
...
while cap.isOpened():
    ...
    # 6. Resize for side-by-side output (960x540 each)
